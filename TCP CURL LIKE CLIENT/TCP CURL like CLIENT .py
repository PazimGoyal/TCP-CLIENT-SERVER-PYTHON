import socket
#Name of command line is Pazim ... you can use word pazim similar to curl
...
#--------------------------------------------------------------------
def main():
    url1="Pazim get www.httpbin.org/get?NAME=PazimGoyal&RegNo=40069412"
    url2="Pazim get -v -h Keep-Alive:10 -h Accept-language:en -h key:value www.httpbin.org/status/418"
    url3="Pazim get -v -h Keep-Alive:10 -h Accept-language:en www.pazim.xyz -o file2.html"
    url4="Pazim post -v -h Content-Type:application/x-www-form-urlencoded -d userName=PAZIM_MRIDUL&password=GOYAL_PATHAK httpbin.org/post -o temp.txt"
